...
namespace MattC.DockableCLArgs
{
    ...
    [ProvideToolWindow(typeof(DockableCLArgsToolWindow), Style = VsDockStyle.Tabbed, Orientation = ToolWindowOrientation.Bottom)]
    ...
    public sealed class DockableCLArgsPackage : Package//, IVsPersistSolutionOpts
    {
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.FindToolWindow(typeof(DockableCLArgsToolWindow), 0, true);
            if ((null == window) || (null == window.Frame))
            {
                throw new NotSupportedException(Resources.CanNotCreateWindow);
            }
            MyWindow = (DockableCLArgsToolWindow)window;
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidDockableCLArgsCmdSet, (int)PkgCmdIDList.cmdidToolDCLA);
